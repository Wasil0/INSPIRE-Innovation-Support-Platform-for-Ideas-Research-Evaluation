...
const FydpProgress = () => {
  ...
  const calculateStepStates = () => {
    ...
    const stageMap = [
      ...
      { stage: stage3_completed, id: 3, title: "Proposal Submission", description: "Submit your detailed project proposal", icon: FileText, route: "/student/proposal-submission" },
